            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="contact-info">
                        ...
                        <address>
                            <p><i class="fa fa-institution fa-2x" style="color: aquamarine;"> </i><span
                                        style="font-weight:900;font-size: 30px;"> PSP-BOOK</span></p>
                            <p><i class="fa fa-map-marker fa-1x"> </i> Tecco Green Nest 2, 287 Phan Văn Hớn, phường Tân
                                Thới Nhất, quận 12, thành phố Hồ Chí Minh </p>

                            <p><i class="fa fa-phone"></i> 0819277274</p>
                            <p><i class="fa fa-envelope-open"></i> phamminh12a6@gmail.com</p>
                        </address>
